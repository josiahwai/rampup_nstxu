function flsignals = get_flsignals(shot, times, tree, tags)
%
% GET_FLSIGNALS
%
% SYNTAX: get_flsignals
% 
% PURPOSE: Read flux loop signals from MDSplus.
%      
% INPUTS:
%
...
%                      operations tree
%
%   tags...............cell array containing MDSplus tag names for flux
%                      loop signals
%
% OUTPUTS:
%
%   flsignals..........structure with the following fields
%
%                         shot:   NSTX-U shot number
%                       
%                         tags:   MDSplus tag names for flux loops
%
%                         times:  array of times
%
%                         sigs:   matrix of flsignals with dimensions 
...
if nargin == 0
    error('ERROR get_flsignals: must specify NSTX-U shot number')
end
