...
%
%  INPUTS: index_in_y and workspace after gs_eq_analysis
%
%  OUTPUTS:  lae.y
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if isfield(index_in_y,'aminor')
  lae.y(index_in_y.aminor) = aminor;
end
if isfield(index_in_y,'nbbbs')
  lae.y(index_in_y.nbbbs) = nbbbs;
end
...
if isfield(index_in_y,'fluxerror')
  lae.y(index_in_y.fluxerror) = fluxerror;
end
...
if isfield(index_in_y,'frc')
  frc = (mrcc*ic+mrpc'*pcurrt(:)).*ic;
  lae.y(index_in_y.frc) = frc;
end
if isfield(index_in_y,'fzc')
  fzc = (mzcc*ic+mzpc'*pcurrt(:)).*ic;
  lae.y(index_in_y.fzc) = fzc;
end
