/*************************************************************************
SYNTAX: [hr,hz,fl] =fine1c(ri,ro,zl,zu,cur,rp,zp,(idebug))
...
METHOD:  To compile in matlab: mex fine1c.c fine.c -lm
...
*/
   fine1c(&mn,ri_pt, ro_pt, zl_pt, zu_pt, cur_pt, rp_pt, zp_pt, 
                     hr_pt, hz_pt, fl_pt);
   return;
}
...
int fine1c(integer *num,doublereal *ri_pt, doublereal *ro_pt, doublereal *zl_pt, 
