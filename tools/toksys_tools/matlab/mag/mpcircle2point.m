function M = mpcircle2point(r,z,rp,zp,a,nrh,nt);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%  USAGE:   M = mpcircle2point(r,z,rp,zp,a);
%
%  PURPOSE: Return poloidal flux from circular plasma where current
%           density is proportional to R (as it is for pprime)
%
...
%          See also mcircle2point, mfcircle2point
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if nargin <= 5 % If true then use look-up table with fix for a/rp < 0.04
  ...
  if isempty(a1)
    filename = which('mpcircle2point.mat');
    load(filename)
  end
