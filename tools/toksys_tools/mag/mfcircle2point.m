function M = mfcircle2point(r,z,rp,zp,a,nrh,nt);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%  USAGE:   M = mfcircle2point(r,z,rp,zp,a);
%
%  PURPOSE: Return poloidal flux from circular plasma where current
%           density is proportional to 1/R (as it is for ffprim)
%
...
%          See also mcircle2point, mpcircle2point
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		
%  VERSION %W% %G%
%
%  WRITTEN BY: Anders Welander ON 2015-02-24
%
...
if nargin <= 5 % If true then use look-up table with fix for a/rp < 0.04
  ...
  if isempty(a1)
    filename = which('mfcircle2point.mat');
    load(filename)
  end
